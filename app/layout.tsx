...
export const metadata = {
  ...
  keywords: 'Symfony, Sylius, PHP, Developer, Freelance, France, Lille, Mulet, Quality, Open Source, E-commerce, B2C, B2B',
  openGraph: {
      ...
      <footer className="bg-beige">
        <div className="max-w-7xl mx-auto py-12 px-6 md:flex md:items-center md:justify-between lg:px-8">
          <div className="flex justify-center space-x-6 md:order-3">
            <a href="https://twitter.com/ValentinSilves" className="text-green-tree hover:text-dark-blue"
               target="_blank">
            ...
            <a href="https://github.com/vasilvestre/" className="text-green-tree hover:text-dark-blue" target="_blank">
